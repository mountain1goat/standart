let objects = document.querySelector('#snowman', '#mouth03', '#neck01', '#neck03', '#neck04', '#neck05', '#hand_left01', '#hand_right01', '#hand_left02', '#hand_right02', '#eyes01', '#eyes02', '#eyes03', '#eyes05', '#nose01', '#nose02', '#head02', '#head03', '#head05', '#head06');
